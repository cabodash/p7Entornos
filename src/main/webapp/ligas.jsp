				...
				<div class="table-wrapper">
					<table class="alt">
						...
						<tbody>
							...
							for (Liga l: connexion.todasLigas()){
								out.print("<tr>\r\n"
										+ "	<td width=\"60\" rowspan=\"2\"><a href=\"liga.jsp?cod_liga="+l.getCod_liga()+"&nombre_liga="+l.getNombre()+"&pais_liga="+l.getPais()+"\"><img width=\"100\" src=\"images/ligas/"+l.getCod_liga()+".png\"></a></td>\r\n"
										+ "	<td width=\"300\" colspan=\"3\" style=\"padding-left: 15px\" >\r\n"
										+ "		<p style=\"text-align: center;color:red;font-size:1em;text-decoration: underline;font-weight: bold;\">"+l.getNombre()+"<p>\r\n"
										+ "	</td>\r\n"
										+ "\r\n");
								
								for (Equipo e: equipos){
									if (e.getCod_liga() == l.getCod_liga())
										out.print("	<td rowspan=\"2\" width=\"60\" style=\"text-align: center\">\r\n"
												+ "<a href=\"equipo.jsp?cod_equipo="+e.getCod_eqipo()+"\"><img title=\""+e.getNombre()+"\" width=\"50\" src=\"images/equipos/"+e.getCod_eqipo()+".png\">"
												+ "</td>\r\n");
								}
								out.print("</tr>\r\n"
										+ "<tr>\r\n"
										+ "	<td width=\"50\" style=\"text-align: left; padding-left: 14px\">\r\n"
										+ "		<img width=\"50\" style=\"margin: 10px\" src=\"images/paises/"+l.getPais()+".png\">\r\n"
										+ "	</td>\r\n"
										+ "	<td width=\"205\"></td>\r\n"
										+ "</tr>");
							}
