					...
					<div class="container">
						<div id="content">
							...
							<!-- Content -->
								...
								<h3>Alta Liga</h3>
								<form action="/FIFA23/operaciones.jsp?tipo=altaliga" method="post">
									<div class="row gtr-50">
										<div class="">
											<input required type="text" name="name" id="name" placeholder="Nombre liga" style="width:450px"; maxlength="20"/>
										</div>
										<div class="">
											<input required type="text" name="country" id="leg" placeholder="El país de la liga" maxlength="9"/>
										</div>
