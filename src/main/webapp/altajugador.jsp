					...
					<div class="container">
						<div id="content">
							...
							<!-- Content -->
								...
								<h3>Alta Jugador</h3>
								<form action="/FIFA23/operaciones.jsp?tipo=altajugador" method="post">
									<div class="row gtr-50">
										<div class="">
											<input required type="text" name="name" id="name" placeholder="Nombre jugador" style="width:450px"; maxlength="20"/>
										</div>
										<div class="">
											<input required type="text" name="leg" id="leg" placeholder="Pierna buena del jugador " maxlength="9"/>
										</div>
										<div class="">
											<input required type="number" name="team" id="team" placeholder="Código del equipo" maxlength="3"/>
										</div>
										<div class="">
											<input required type="text" name="country" id="country" placeholder="País del jugador" maxlength="20"/>
										</div>
										<div class="">
											<input required type="number" name="height" id="height" placeholder="Altura del jugador" maxlength="4"/>
										</div>
