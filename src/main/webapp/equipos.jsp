						...
						<tbody>
							...
							for (Equipo e: connexion.todosEquipos()){
								out.print("<tr>\r\n"
										...
										+ "		<p style=\"text-align: center;color:red;font-size:1em;text-decoration: underline;font-weight: bold;\">"+e.getNombre()+"<p>\r\n"
										+ "	</td>\r\n"
										+ "\r\n");
								...
								out.print("</tr>\r\n"
										...
										+ "		<img width=\"50\" style=\"margin: 10px\" src=\"images/paises/"+connexion.dameLiga(e.getCod_liga()).getPais()+".png\">\r\n"
										+ "	</td>\r\n"
										+ "	<td width=\"205\"></td>\r\n"
										+ "</tr>");
							}
