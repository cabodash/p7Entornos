					...
					<div class="container">
						<div id="content">
							...
							<!-- Content -->
								...
								<h3>Alta Equipo</h3>
								<form action="/FIFA23/operaciones.jsp?tipo=altaequipo" method="post">
									<div class="row gtr-50">
										<div class="">
											<input required type="text" name="name" id="name" placeholder="Nombre equipo" style="width:450px"; maxlength="20"/>
										</div>
										<div class="">
											<input required type="number" name="cod_liga" id="team" placeholder="Código de la líga" maxlength="3"/>
										</div>
