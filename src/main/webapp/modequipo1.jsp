					...
					<div class="container">
						<div id="content">
							...
							<!-- Content -->
								...
								<form action="/FIFA23/modequipo2.jsp" method="post">
									<div class="row gtr-50">
										<select name="cod_equipo" id="cod_jugador">
											<%
									...
									<div style="padding-top:22px;">
											<ul class="actions">
												<li><input type="submit" class="button alt" value="Seleccionar para modificar" /></li>
											</ul>
									</div>
