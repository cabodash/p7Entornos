				...
				<section class="wrapper style1" style="height:500px;">
					<div class="container">
						<div id="content">
							...
							Jugador j = connexion.dameJugador(cod_jugador);
							%>
								<article>
									
									<section class="col-6 col-12-narrower">
								<h3>Modificar Jugador</h3>
								<form action="/FIFA23/operaciones.jsp?tipo=modjugador&cod_jugador=<% out.print(cod_jugador); %>" method="post">
									<div class="row gtr-50">
										<div class="">
											<input required value="<% out.print(j.getNombre()); %>" type="text" name="name" id="name" placeholder="Nombre jugador" style="width:450px"; maxlength="20"/>
										</div>
										<div class="">
											<input required value="<% out.print(j.getPierna()); %>" type="text" name="leg" id="leg" placeholder="Pierna buena del jugador " maxlength="9"/>
										</div>
										<div class="">
											...
											<%
												...
												for (Equipo e: equipos){
													if (e.getCod_eqipo() == j.getCod_equipo())
														out.print("<option selected=\"selected\" value=\""+e.getCod_eqipo()+"\">"+e.getNombre()+"</option>");
													else
														out.print("<option value=\""+e.getCod_eqipo()+"\">"+e.getNombre()+"</option>");
												}
											%>
											</select>
										</div>
										<div class="">
											<input required value="<% out.print(j.getPais()); %>" type="text" name="country" id="country" placeholder="País del jugador" maxlength="20"/>
										</div>
										<div class="">
											<input required value="<% out.print(j.getAltura()); %>" type="number" name="height" id="height" placeholder="Altura del jugador" maxlength="4"/>
										</div>
									...
									<div style="padding-top:22px;">
											<ul class="actions">
												<li><input type="submit" class="button alt" value="Guardar datos" /></li>
											</ul>
									</div>
