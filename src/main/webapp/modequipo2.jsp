				...
				<section class="wrapper style1" style="height:500px;">
					<div class="container">
						<div id="content">
							...
							Equipo e = connexion.dameEquipo(cod_equipo);
							%>
								<article>
									
									<section class="col-6 col-12-narrower">
								<h3>Modificar Equipo</h3>
								<form action="/FIFA23/operaciones.jsp?tipo=modequipo&cod_equipo=<% out.print(cod_equipo); %>" method="post">
									<div class="row gtr-50">
										<div class="">
											<input value="<% out.print(e.getNombre()); %>" required type="text" name="name" id="name" placeholder="Nombre equipo" style="width:450px"; maxlength="20"/>
										</div>
										<div class="">
											...
											<%
												...
												for (Liga l: ligas){
													if (e.getCod_liga() == l.getCod_liga())
														out.print("<option selected=\"selected\" value=\""+l.getCod_liga()+"\">"+l.getNombre()+"</option>");
													else
														out.print("<option value=\""+l.getCod_liga()+"\">"+l.getNombre()+"</option>");
												}
											%>
											</select>
										</div>
